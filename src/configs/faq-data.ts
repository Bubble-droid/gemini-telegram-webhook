...
3. **管理员权限 (Windows)**：前往 **设置 -> 通用**，启用 **以管理员身份运行** 并重启客户端。`,
  },
  {
    ...
    answer: `**Q: Windows 开机自启后，托盘图标透明、消失或无法点击？**
...
\`\`\``,
  },
  {
    ...
    answer: `**Q: 如何快速导入单个节点分享链接 (如 ss://, vmess://)？**
...
**重要提示**：规则的顺序至关重要。请将你手动添加的这些规则集规则，放置在路由规则列表的**靠前位置**，以确保它们能被优先匹配。`,
  ...
  // 🐞 B.2.4 内核错误 (Core Errors)
  {
    ...
    answer: `**Q: 报错 "initialize cache-file: timeout"？**
...
3.  **修正配置**: 根据文档核对的结果，修正你配置中的错误字段或其值，然后重启内核。`,
  ...
  // 🍏 B.2.6 macOS 专项 (macOS Specifics)
  {
    ...
    answer: `**Q: macOS 提示“已损坏”、“无法验证开发者”或“将对电脑造成伤害”，导致程序无法打开？**
...
*   **macOS/Linux**: 前往 **设置 -> 内核** 页面，点击 **授予特权** 按钮为内核授权。
    *   **如果需要配置防火墙**: 请参考 Mihomo 的 [TUN 入站](https://wiki.metacubex.one/en/config/inbound/tun/#stack) 文档。`,
  },
  {
    keywordGroups: [
...
*   **解决方案**:
  ...
  },
  {
    ...
    answer: `**Q: TUN 模式启动后无法上网或网络异常？只启用 TUN 无法访问网站？必须同时开启系统代理才能访问网站？**
...
A: 尝试将你操作系统的 DNS 服务器地址修改为公共 DNS，例如 \`8.8.8.8\` 或 \`1.1.1.1\`。`,
  },
