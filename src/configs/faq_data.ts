...
A: 通过 **概览 -> 活动连接** 面板右键添加的规则，本质上是向本地的三个特定规则集文件（\`direct.xxx\`, \`proxy.xxx\`, \`reject.xxx\`）追加条目。你需要手动在配置中引用这些规则集，才能让这些规则真正生效。
  ...
  // 🍏 B.2.6 macOS 专项 (macOS Specifics)
  {
    keywordGroups: [
      ...
      [
        'mac|苹果',
        '(软件|客户端|程序|app|应用)?',
        '(启动|运行)不(了|起来)|打不开|启动不了|([不没无]法|不能)(启动|运行|打开)|没反应|无响应|闪退|点不开|运行不了|白屏|一直(转圈)?加载',
      ],
